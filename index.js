...
// ANSWER: Each function only takes in one argument wich can vary only once
...
class Cache {
  ...
  multiplyNum(num1, num2){
    ...
    if(combined === this.cache[combined]){
      return this.cache[combined]
    }
    let answer = num1 * num2
    this.cache[combined] = answer
    return answer
  }
}
...
function noCacheMultiplyNum(num1, num2){
  let answer = num1 * num2
  return answer
}
...
// ANSWER: The cache function will run faster
...
console.log(noCacheMultiplyNum(8, 8))
console.log(noCacheMultiplyNum(8, 8))
console.log(noCacheMultiplyNum(8, 8))
console.log(noCacheMultiplyNum(8, 8))
...
console.log(cacheMoney.multiplyNum(8, 8))
console.log(cacheMoney.multiplyNum(8, 8))
console.log(cacheMoney.multiplyNum(8, 8))
console.log(cacheMoney.multiplyNum(8, 8))
